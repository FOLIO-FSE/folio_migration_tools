...
class Blurbs:
    ...
    FeeFineOnwerMapping = ("Terms Mapping", "Reference data mapping for Fee/Fine Owners.")
    FeeFineTypesMapping = ("Terms Mapping", "Reference data mapping for Fee/Fine Types.")
    CategoriesMapping = (
