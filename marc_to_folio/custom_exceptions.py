...
class TransformationDataError(TransfomationError):
    ...
    def __init__(self, id, message="Transformation failed"):
        self.id = id
        self.message = message
        super().__init__(self.message)

    def __str__(self):
        return f'Data issue. Consider fixing.\t{self.id}\t{self.message}'
...
class TransformationCriticalDataError(TransfomationError):
    ...
    def __str__(self):
        return f'Critical data issue. Needs fixing\t{self.id}\t{self.message}'
...
class TransformationCodeError(TransfomationError):
    ...
    def __str__(self):
        return f'Coding issue.\t{self.id}\t{self.message}'
...
class TransformationProcessError(TransfomationError):
    ...
    def __str__(self):
        return f'Process issue.\t{self.id}\t{self.message}'