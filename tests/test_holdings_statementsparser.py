...
def test_linked_fields_2():
    ...
    ret = HoldingsStatementsParser.parse_linked_field(
        pattern_field, linked_value_field1
    )
    assert ret["statement"]["statement"] == stmt
    ret = HoldingsStatementsParser.parse_linked_field(
        pattern_field, linked_value_field2
    )
...
def test_linked_fields_15():
    ...
    linked_value_field2 = get_sfs(
        r"=863  40$81.2$a69-70$b3-6$i1990-1991$j05/06-11/12$wg"
    )
    ...
    linked_value_field4 = get_sfs(
        r"=863  40$81.4$a72-74$b9-1$i1992-1994$jsummer issue,-01/02$wg"
    )
    ...
    ret1 = HoldingsStatementsParser.parse_linked_field(
        pattern_field, linked_value_field1
    )
    assert ret1["statement"]["statement"] == stmt1

    ret2 = HoldingsStatementsParser.parse_linked_field(
        pattern_field, linked_value_field2
    )
    assert ret2["statement"]["statement"] == stmt2

    ret3 = HoldingsStatementsParser.parse_linked_field(
        pattern_field, linked_value_field3
    )
    assert ret3["statement"]["statement"] == stmt3

    ret4 = HoldingsStatementsParser.parse_linked_field(
        pattern_field, linked_value_field4
    )
    assert ret4["statement"]["statement"] == stmt4

    ret5 = HoldingsStatementsParser.parse_linked_field(
        pattern_field, linked_value_field5
    )
    assert ret5["statement"]["statement"] == stmt5

    ret6 = HoldingsStatementsParser.parse_linked_field(
        pattern_field, linked_value_field6
    )
...
def test_get_textual_statements():
    ...
    with open(path, "rb") as openfile:
        ...
        HoldingsStatementsParser.get_textual_statements(record, "866", return_dict, "1")
        statements = set(
            [
                "1943:Sept. 30,",
                "1943:Oct. 31.",
                ...
                "1946:Sept.,",
                "1946:Oct.-1946:Dec.,",
                "1947:Jan. 31-1947:May 31,",
                "1947:Sept. 30-1947:Oct. 31,",
                "1947:Dec.",
                "COPY 2:",
                "1944:Mar. 31,",
                "1944:Oct. 31-1944:Nov. 30,",
                "1945:Jan. 31,",
                "1945:Feb. 28,",
                "1945:Mar. 31-1945:May 31,",
                "1945:Sept. 30-1945:Dec. 31,",
                "1946:Jan.-1946:Apr,",
                "1946:Oct.-1946:Dec.,",
                "1947:Feb. 28,",
                "1947:Apr. 30-1947:May 31,",
                "1947:Oct. 31,",
                "1947:Dec.",
                "COPY 3:",
                "1945:Jan. 31,",
                "1945:Mar. 31,",
                "1945:Apr. 30-1945:May 31,",
                "1946:Oct.",
                "1947:May 31,",
                "1947:Oct. 31.",
                "1947:Dec. 31.",
...
def test_get_cron_from_to_month_span():
    ...
    cron_from, cron_to, hlm_stmt, is_span = HoldingsStatementsParser.get_cron_from_to(
        pattern_field, value_field
    )
...
def test_parse_linked_field_with_notes():
    ...
    value_field = make_field(
        {"a": "10", "b": "5", "i": "2015", "z": "Some note", "x": "Staff note"}
    )
    result = HoldingsStatementsParser.parse_linked_field(pattern_field, value_field)
