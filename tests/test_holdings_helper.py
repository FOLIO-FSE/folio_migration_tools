...
def test_merge_holding():
    holding_1 = dict(
        ...
        holdingsStatementsForSupplements=[
            {"statement": "stmt2", "note": "stmt2", "staffNote": ""},
            {"uri": "1", "linkText": "1", "publicNote": "1", "relationshipId": "1"},
        ],
        holdingsStatements=[{"statement": "stmt3", "note": "stmt3", "staffNote": ""}],
    )

    holding_2 = dict(
        formerIds=["c", "d"],
        electronicAccess=[{"uri": "1", "linkText": "1", "publicNote": "1", "relationshipId": "1"}],
        holdingsStatementsForIndexes=[{"statement": "stmt1", "note": "stmt1", "staffNote": ""}],
        holdingsStatements=[{"statement": "stmt4", "note": "stmt4", "staffNote": ""}],
    )
...
def test_merge_holdings_do_not_remove_dupe_stmts():
    holding_1 = dict(
        ...
        electronicAccess=[{"uri": "2"}],
        holdingsStatementsForSupplements=[
            {"statement": "stmt2", "note": "stmt2", "staffNote": "apa"},
            {"uri": "1", "linkText": "1", "publicNote": "1", "relationshipId": "1"},
        ],
        holdingsStatements=[
            {"statement": "stmt3", "note": "stmt3", "staffNote": ""},
            {"statement": "stmtDUPE", "note": "noteDDUPE", "staffNote": ""},
        ],
    )
    ...
    holding_2 = dict(
        ...
        holdingsStatements=[
            {"statement": "stmt4", "note": "stmt4", "staffNote": ""},
            {"statement": "stmtDUPE", "note": "noteDDUPE", "staffNote": ""},
        ],
    )
    merged_holding = HoldingsHelper.merge_holding(holding_1, holding_2)
...
def test_merge_holdings_preserve_order():
    dupe_stmt = {"statement": "stmtDUPE", "note": "noteDDUPE", "staffNote": ""}
    holding_1 = dict(
        formerIds=["a", "b"],
        electronicAccess=[{"uri": "2"}],
        holdingsStatements=[
...
def test_merge_holding3():
    h1 = {
        ...
        "holdingsStatementsForSupplements": [{"statement": ""}],
        "discoverySuppress": False,
        "sourceId": "036ee84a-6afd-4c3c-9ad3-4a12ab875f59",
        "hrid": "ho00900565900",
    }
